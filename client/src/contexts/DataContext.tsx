...
const MOCK_CARDS: Card[] = [
  {
    ...
    printType: 'Holo',
    authentic: true,
    photos: ['/images/charizard-ex.jpg'],
  ...
  },
  {
    ...
    conditionScore: 9,
    price: 280,
    image: '/images/charizard-ex-151.jpg',
    vendorId: '3',
    ...
    printType: 'Holo',
    authentic: true,
    photos: ['/images/charizard-ex-151.jpg'],
    createdAt: new Date().toISOString(),
  },
  {
    id: '3',
    ...
    conditionScore: 10,
    price: 520,
    image: '/images/charizard-full-art.jpg',
    vendorId: '4',
    ...
    printType: 'Holo',
    authentic: true,
    photos: ['/images/charizard-full-art.jpg'],
    createdAt: new Date().toISOString(),
  },
  {
    id: '4',
